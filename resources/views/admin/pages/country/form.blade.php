                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Country</label>
                        <input type="text" class="form-control" placeholder="Enter country name" name="country" value="{{ old('country', isset($details->country) && $details->country ? $details->country : '') }}" required="">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- select -->
