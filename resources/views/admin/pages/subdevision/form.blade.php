                ...
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="district_id" id="district_id">
                          ...
                          if($district){
                              ...
                              ?>
                                <option value="{{ $value->id }}" {{ isset($details->district_id) && $details->district_id == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                              <?php
                              }
                          }
                          ?>
                    ...
                    <div class="col-sm-4">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Sub Devesion Name</label>
                        <input type="text" class="form-control" placeholder="Enter sub devesion name" name="name" value="{{ old('name', isset($details->name) && $details->name ? $details->name : '') }}">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- select -->
