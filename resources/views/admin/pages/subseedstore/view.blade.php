                ...
                <form method="get" action="" autocomplete="off" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="form-group">
                        <select class="form-control select2" name="districtstore_id" id="districtstore_id">
                          ...
                          if($districtstore){
                              ...
                              ?>
                                <option value="{{ $value->id }}" {{ isset($serach_data['districtstore_id']) && $serach_data['districtstore_id'] == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                              <?php
                              }
                          }
                          ?>
                      ...
                      <div class="form-group">
                        <select class="form-control select2" name="mainstore_id" id="mainstore_id">
                          ...
                          if($mainstore){
                              ...
                              ?>
                                <option value="{{ $value->id }}" {{ isset($serach_data['mainstore_id']) && $serach_data['mainstore_id'] == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                              <?php
                              }
                          }
                          ?>
                      ...
                      <div class="form-group">
                        <select class="form-control select2" name="subdevision_id" id="subdevision_id">
                          ...
                          if($subdevision){
                              ...
                              ?>
                                <option value="{{ $value->id }}" {{ isset($serach_data['subdevision_id']) && $serach_data['subdevision_id'] == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                              <?php
                              }
                          }
                          ?>
                      ...
                      <div class="form-group">
                        <select class="form-control select2" name="block_id" id="block_id">
                          ...
                          if($block){
                              ...
                              ?>
                                <option value="{{ $value->id }}" {{ isset($serach_data['block_id']) && $serach_data['block_id'] == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                              <?php
                              }
                          }
                          ?>
                      ...
                      <div class="form-group">
                        <select class="form-control select2" name="panchanyat_id" id="panchanyat_id">
                          ...
                          if($panchanyat){
                              ...
                              ?>
                                <option value="{{ $value->id }}" {{ isset($serach_data['panchanyat_id']) && $serach_data['panchanyat_id'] == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                              <?php
                              }
                          }
                          ?>
                    ...
                    <div class="col-sm-4">
                      <!-- text input -->
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Enter pin name" name="pincode" value="{{ isset($serach_data['pincode']) && $serach_data['pincode'] ? $serach_data['pincode'] : '' }}">
                      </div>
                    </div>
                    <div class="col-5">
                      <input type="text" class="form-control" placeholder="Sub Seed Store name" name="name" value="{{ isset($serach_data['name']) && $serach_data['name'] ? $serach_data['name'] : '' }}">
                    </div>
                    <div class="col-5">
                ...
                <table class="table table-bordered">
                  ...
                  @if(isset($rows) && $rows)
                    ...
                    <tr> 
                      ...
                      <td>{{ $res->name }}</td>
                      <td>{{ $res->subdevision }}</td>
                      <td>{{ $res->block }}</td>
                      <td>{{ $res->panchanyat }}</td>
