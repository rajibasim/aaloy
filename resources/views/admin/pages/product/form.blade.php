                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Comodity name" name="name" value="{{ old('name', isset($details->name) && $details->name ? $details->name : '') }}">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- select -->
                        ...
                        <select class="form-control select2" name="brand_id" id="brand_id" required="">
                          ...
                          @if($brand)
                             @foreach ($brand as $val)
                              <option value="{{ $val->id }}" {{ isset($details->brand_id) && $details->brand_id == $val->id ? 'selected' : '' }}>{{ $val->name }}</option>
                             @endforeach
                          @endif
                        </select>
                      </div>
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="unit_id" id="unit_id" required="">
                          ...
                          @if($unit)
                             @foreach ($unit as $val)
                              <option value="{{ $val->id }}" {{ isset($details->unit_id) && $details->unit_id == $val->id ? 'selected' : '' }}>{{ $val->name }}</option>
                             @endforeach
                          @endif
                        </select>
                      </div>
