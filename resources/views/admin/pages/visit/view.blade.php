                  ...
                  <div class="row">
                    ...
                    <div class="col-3">
                      <select class="form-control" name="visit_status">
                        ...
                        <option value="1" {{ isset($serach_data['visit_status']) && $serach_data['visit_status'] == 1 ? 'selected=""' : '' }}>Visited</option>
                        <option value="2" {{ isset($serach_data['visit_status']) && $serach_data['visit_status'] == 2 ? 'selected=""' : '' }}>Cancelled</option>
                        <option value="3" {{ isset($serach_data['visit_status']) && $serach_data['visit_status'] == 3 ? 'selected=""' : '' }}>No Responce</option>
                      </select>
                    </div>
                    <div class="col-1">
                    ...
                    <tr> 
                      ...
                      <td style="width: 200px;">
                        <select id="{{ $res->id }}" class="form-control select2 changeStatus">
                          ...
                          <option value="1" {{ $res->visit_status == 1 ? 'selected=""' : '' }}>Visited</option>
                          <option value="2" {{ $res->visit_status == 2 ? 'selected=""' : '' }}>Cancelled</option>
                          <option value="3" {{ $res->visit_status == 3 ? 'selected=""' : '' }}>No Responce</option>
                        </select>
                      </td>
                    </tr>
                    @endforeach
    ...
    $(".changeStatus").on("change", function(e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.href = 'visit-request/change-status?id='+id+'&value='+value;
          }
        })
    });
});
