...
class BlogController extends Controller{
    ...
    public function form(Request $request, $id = null){
        ...
        $data['category'] = $this->CommonModel->get_all($table = 'category', $select = array('*'), $where = array(), $join = array(), $left = array(), $right = array(), $order = array(), $group = "", $limit = array(), $raw = "", $paging = "");
