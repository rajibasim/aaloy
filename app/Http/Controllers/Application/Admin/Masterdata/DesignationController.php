...
class DesignationController extends Controller{
    ...
    public function __construct(){
        ...
        $this->slug = '/masterdata/admin-designation';
    ...
    public function index(Request $request){
        ...
        if($name){
            array_push($where, array('designation.name', 'like', "%{$name}%"));
            $serach_data['name'] = $name;
        }

        if($status){
            array_push($where, array('designation.status', '=', $status));
        ...
        return view('admin.pages.designation.view', $data);
    }
    ...
    public function form(Request $request, $id = null){
        ...
        return view('admin.pages.designation.form', $data);
    }
