...
class BannerController extends Controller{
    ...
    public function index(Request $request){
        ...
        if($banner){
            array_push($where, array('banner', 'like', "%{$banner}%"));
            $serach_data['banner'] = $banner;
        }
    ...
    public function save(Request $request){
        ...
        $validator = Validator::make($request->all(), [ 
            'banner' => 'required|unique:banner,banner,' . $id,
            'latitude' => 'required',
            'longitude' => 'required',
            'status' => 'required', 
        ]); 
        ...
        if ($validator->fails()) { 
            ...
            if($id){
                $post_data = array(
                    ...
                    'slug' => Str::slug($request->input('banner')),
