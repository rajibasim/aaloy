...
class CountryController extends Controller{
    ...
    public function index(Request $request){
        ...
        if($country){
            array_push($where, array('country', 'like', "%{$country}%"));
            $serach_data['country'] = $country;
        }
        ...
        return view('admin.pages.country.view', $data);
    }
    ...
    public function form(Request $request, $id = null){
        ...
        return view('admin.pages.country.form', $data);
    }
    ...
    public function save(Request $request){
        ...
        $validator = Validator::make($request->all(), [ 
            'country' => 'required|unique:country,country,' . $id,
        ]); 
