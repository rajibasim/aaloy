...
class BlockController extends Controller{
    ...
    public function __construct(){
        ...
        $this->slug = '/masterdata/admin-block';
        $this->title = 'Block';
        $this->table = 'block';
    }
    ...
    public function index(Request $request){
        ...
        $where = array();
        $where = array(
            array('block.is_deleted', '=', 0)
        );
        if($name){
            array_push($where, array('block.name', 'like', "%{$name}%"));
            $serach_data['name'] = $name;
        }

        if($status){
            array_push($where, array('block.status', '=', $status));
        ...
        $data['rows'] = $this->CommonModel->get_all($table = $this->table, $select = array('*', 'district.name as district', 'subdevision.name as subdevision'), $where, $join = array(), $left = array(array('district', 'block.district_id', '=', 'district.id'), array('subdevision', 'block.subdevision_id', '=', 'subdevision.id')), $right = array(), $order = array(), $group = "", $limit = array(), $raw = "", $paging = "20");        
        return view('admin.pages.block.view', $data);
    }
    ...
    public function form(Request $request, $id = null){
        ...
        return view('admin.pages.block.form', $data);
    }
    ...
    public function save(Request $request){
        ...
        $validator = Validator::make($request->all(), [ 
            'name' => 'required|unique:block,name,' . $id,
