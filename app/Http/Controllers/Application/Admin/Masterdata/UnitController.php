...
class UnitController extends Controller{
    ...
    public function __construct(){
        ...
        $this->slug = '/masterdata/admin-unit';
        $this->title = 'Unit';
        $this->table = 'unit';
    }
    ...
    public function index(Request $request){
        ...
        if($name){
            array_push($where, array('unit.name', 'like', "%{$name}%"));
            $serach_data['name'] = $name;
        }

        if($status){
            array_push($where, array('unit.status', '=', $status));
        ...
        return view('admin.pages.unit.view', $data);
    }
    ...
    public function form(Request $request, $id = null){
        ...
        return view('admin.pages.unit.form', $data);
    }
